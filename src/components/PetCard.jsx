...
const PetCard = ({ petInfo }) => {
    return (
        <div className='group relative max-w-sm rounded-xl overflow-hidden shadow-sm border border-gray-200 bg-white transition-all duration-300 hover:shadow-lg flex flex-col justify-between mx-auto'>
            ...
            <div className='p-4'>
                ...
                <div className='flex flex-wrap md:items-center gap-1.5 text-sm text-gray-500 mb-4 font-medium'>
